              ...
              <tbody className="divide-y divide-[var(--color-line)] text-[var(--color-ink)]">
                {topProductos.map((p) => (
                  <tr key={p.id} className="transition-colors hover:bg-[var(--color-panel-2)]/40">
                    ...
                    <td className="tabular whitespace-nowrap px-2 py-2 text-right text-[var(--color-ink)]">
                      {formatARS(p.ingresoTotal)}
                    </td>
                    <td className="tabular whitespace-nowrap px-2 py-2 text-right text-[var(--color-ink-2)]">
                      {formatNumber(p.unidadesVendidas)}
                    </td>
                    <td className="tabular whitespace-nowrap px-4 py-2 text-right sm:px-5">
                      <span
                        className={
                          p.margen >= 40
